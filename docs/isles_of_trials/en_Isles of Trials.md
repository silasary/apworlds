...
The [player options page for Isles of Trials](../player-options)
contains all the options you need to configure and export a config file.

## What is the goal of Isles of Trials when randomized?

Open the goal chest at the top left corner of the island.
...
Every chest is a location, except the goal chest.
