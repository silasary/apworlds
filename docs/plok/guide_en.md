# Plok Archipelago Randomizer Setup Guide
...
- Hardware or software capable of loading and playing SNES ROM files
    ...
    - An SD2SNES, FXPak Pro ([FXPak Pro Store Page](https://krikzz.com/store/home/54-fxpak-pro.html)), or other
      compatible hardware
- Your legally obtained Plok ROM file, probably named `Plok.sfc`
   - The expected MD5 hash will be `478a2723ff6db38428d9b26cf0d504bf` this can be checked by visiting [Hasher-js](https://www.romhacking.net/hash/)
...
1. Navigate to the Player Options page, configure your options, and click the "Generate Game" button.
    - Player Options page: [Plok Player Options Page](/games/Plok/player-options)
2. You will be presented with a "Seed Info" page.
3. Click the "Create New Room" link.
4. You will be presented with a server page, from which you can download your patch file.
5. Double-click on your patch file, and the Plok Client will launch automatically, create your ROM from the
