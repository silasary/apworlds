# Chrono Trigger Rando-Dalton Imperial Multiworld Setup Guide

## Required Software

- [Archipelago](https://github.com/ArchipelagoMW/Archipelago/releases)
- SNI (SNES Network Interface) - automatically included with your Archipelago installation
...
- Your legally obtained Chrono Trigger ROM file, probably named `Chrono Trigger (USA).sfc`
...
2. The first time you do local generation or patch your game, you will be asked to locate your base ROM file.
   This is your Chrono Trigger ROM file. This only needs to be done once.
...
them. Player options page: [Chrono Trigger RDI Player Options Page](/games/ctrdi/player-options) or the Rando Dalton
Imperial website [RDI Settings Builder](https://ctrando.com/toml_form).
...
1. Navigate to the Player Options page, configure your options, and click the "Generate Game" button.
    - Player Options page: [Chrono Trigger RDI Player Options Page](/games/ctrdi/player-options)
2. You will be presented with a "Seed Info" page.
3. Click the "Create New Room" link.
4. You will be presented with a server page, from which you can download your patch file.
5. Double-click on your patch file, and the CTRDI Client will launch automatically, create your ROM from the
...
files. Your patch file should have a `.apctrdi` extension.
...
tree page: [usb2snes Supported Platforms Page](http://usb2snes.com/#supported-platforms)
