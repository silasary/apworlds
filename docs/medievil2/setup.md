...
- The latest copy of [the medievil client](https://github.com/riezahughes/Medievil2APClient/releases)
- The latest copy of [the medievil AP World](https://github.com/riezahughes/Medievil2APWorld/releases)
- A legal Rom dump of the NTSC Version of Medievil 2.
