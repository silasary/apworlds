...
## Universal Tracker
Rain World supports the Universal Tracker (UT).
To install it:
1. Download a release of UT [from GitHub](https://github.com/FarisTheAncient/Archipelago/releases).
Rain World's compatibility with UT has been tested with UT v0.2.26 and AP 0.6.6.
2. Place the `.apworld` into the `worlds` folder of your AP installation.

To use it in a multiworld:
1. Start the AP launcher.
2. In the right-hand column, scroll down and open the Universal Tracker.  A modified text client should open.
3. In this client, connect to the multiworld room.
4. Connect to the slot you wish to track. Rain World has yaml-less support, 
meaning a yaml is not required to be in the worlds folder to track.
