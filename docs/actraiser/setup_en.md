# ActRaiser Randomizer Setup Guide
...
- Hardware or software capable of loading and playing SNES ROM files
    ...
    - An SD2SNES, FXPak Pro ([FXPak Pro Store Page](https://krikzz.com/store/home/54-fxpak-pro.html)), or other
      compatible hardware
- Your legally obtained ActRaiser ROM file, probably named `ActRaiser.sfc`
   - The expect MD5 hash will be `635d5d7dd2aad4768412fbae4a32fd6e` this can be checked by visiting [Hasher-js](https://www.romhacking.net/hash/)
      and loading your rom

## Optional Software
- ActRaiser Tracker
	- ActRaiser Archipelago PopTracker pack from the pinned post in the Actraiser Archipelago thread.
...
Once the Apworld has been installed select `Generate Template Options` from the Archipelago Launcher and it will generate 
an `Actiraiser.yaml` config file for you.
...
1. Navigate to the Player Options page, configure your options, and click the "Generate Game" button.
    - Player Options page: [ActRaiser Player Options Page](/games/ActRaiser/player-options)
2. You will be presented with a "Seed Info" page.
3. Click the "Create New Room" link.
4. You will be presented with a server page, from which you can download your patch file.
5. Double-click on your patch file, and the ActRaiser Client will launch automatically, create your ROM from the
...
files. Your patch file should have a `.apactr` extension.
...
After patching the game and launching your client you must first play until you name your character.
