# MGS: Masala Garden Salad Setup Guide
...
1. Create your options YAML file. One can be created on the [MGS: Masala Garden Salad options page](../../../games/MGS%3A%20Masala%20Garden%20Salad/player-options).
