...
Clear a full 28-day run on your goal difficulty tier, 7 by default.
...
Archipelago items appear as purchasable stock in the Gift Shop, shown as a mystery
box. Buying one sends the check.
