...
## Joining a _Multiworld_ Session

After the host has generated the seed and has given you the connection information you can use the `Launcher` program 
...
## Joining a _Multitroid_ Session

Assuming there is someone hosting a Multitroid server you can navigate to the `Multitroid` menu in the AM2R settings
...
If the testers can do it you can too, and if you cant do it play on an easier difficulty.
