...
### Game Install
1. Install an x86 version of BepInEx 5.4.x to a fresh copy of Sonic Dreams Collection. Do not run the game yet.
...
3. Run the game to generate BepInEx's config data. If the mod installed properly, all the game buttons should be greyed out.
