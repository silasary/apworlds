# Glass Animals Discography Setup Guide
...
3. Edit the YAML to your liking (or use the [player options page](/games/Glass%20Animals%20Discography/player-options) on the website)
4. Generate the game
...
2. Enter all the details into the client application's window, including the game name, which in this case is `Glass Animals Discography`
